...
initial_url_pattern = 'https://www.aliexpress.com/store/group/Custom-made-Wall-Stickers/1225042_259917284/31.html?spm=2114.12010612.8148361.10.626f6048YIxtUz&origin=n&SortType=bestmatch_sort&g=y'
#try:
...
while not got_to_end:
    got_to_end = crawling_to_findall_pages(browser,initial_url,'custom-made-wall-stickers-original.csv')
